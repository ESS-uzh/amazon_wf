...
from amazon_wf.compute import get_dirs, pre_process
...
def stack_for_batch(tile_loc, basedir):
    tiles_id_ready = Tile.get_tiles_with_status(tile_loc, 'ready')
    ...
    if tiles_id_to_be_processed:
        ...
        dirpath = f'ess_biodiversity/data/processed_data/amazon/stacks/batch{tile_loc:03}'
